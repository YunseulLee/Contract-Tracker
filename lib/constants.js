...
export const renewalStatusColors = {
  none: { bg: "#1A1D23", text: "#6B7280", border: "#2B3044" },
  pending_review: { bg: "#2D2A18", text: "#F5B731", border: "#8B833A" },
  approved: { bg: "#1B2D2A", text: "#2DD4A0", border: "#3A8B7A" },
  cancelled: { bg: "#2D1B1B", text: "#F06B6B", border: "#8B3A3A" },
};
